using AutoMapper;
using ZERO01.Core.ViewModels.Home.Dtos;
using ZERO01.Core.ViewModels.Orders.Dtos;
using ZERO01.Core.ViewModels.Settings.Dtos;
using ZERO01.Core.ViewModels.Sells.Dtos;
using ZERO01.Core.ViewModels.Users.Dtos;
...
using ZERO01.Core.ViewModels.Warranties.Dtos;
using System;
using ZERO01.Core.ViewModels.Customers.Dtos;

namespace ZERO01.Core
{
